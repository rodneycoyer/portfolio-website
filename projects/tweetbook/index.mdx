...
After building the login page and thinking on it more, this was starting to remind me of a social-media app. So it was dubbed... Tweetbook 🚀✨
...
* **Ease of use** - Its javascript! And Node.js is a server-side platform built on top of Google's v8 engine.
...
When an http request is made to the server, route handlers and controllers look at the headers and body and respond back appropriately. Most of the errors are handled by Express.js.
